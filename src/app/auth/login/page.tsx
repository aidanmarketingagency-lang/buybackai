      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-sm w-full reveal">
          ...
          <button
            ...
            disabled={pending}
            className="w-full flex items-center justify-center gap-3 bg-[#f7f8f8] hover:bg-white text-black font-medium py-3 rounded transition-all duration-[120ms] ease-out text-[14px] disabled:opacity-70 active:scale-[0.98]"
          >
            {pending ? (
              <>
